...
const PROFILES: Profile[] = [
  ...
  { name: "Iridium", preferences: "I like caramel/toffee/fudge/sugar/honey flavours, flavours with biscuit/cake/marzipan inclusions and nut/sesame flavours. I also like fruit/sorbet flavours that are very fresh like yuzu/apricot/pear/elderflower/rose. I don't like banana, coffee, mint, peanut, rhubarb, cheescake, coconut, basil, or those containing alcohols." },
];
